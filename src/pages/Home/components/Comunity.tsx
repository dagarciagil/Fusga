      ...
      <section className="w-[95%] p-5 gap-y-5 sm:w-[90%] h-auto flex flex-col lg:flex-row items-center justify-center lg:rounded-3xl">
        ...
        >
          ...
          <motion.p
            ...
            className="mb-6 text-sm sm:text-base md:text-lg lg:text-base text-ptextC"
          >
          ...
          <Link to="/comunity">
            <motion.button
              ...
              className="px-6 py-3 text-sm text-white bg-greenC hover:bg-purpleC sm:text-base rounded-3xl"
            >
              Leer más
            </motion.button>
          </Link>
        ...
        <motion.aside
          ...
          viewport={{ once: false, amount: 0.3 }}
          animate={{ y: [0, -10, 0] }} // animación vertical continua
          transition={{
            duration: 2,
            repeat: Infinity,
            repeatType: "mirror", // ida y vuelta
            ease: "easeInOut"
          }}
