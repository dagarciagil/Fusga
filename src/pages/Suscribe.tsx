  ...
  return (
    <>
      <main className="flex justify-center items-center h-screen w-screen bg-gray-100">
        {/* Contenedor*/}
        <section className="bg-white p-10 rounded-lg shadow-xl w-full max-w-4xl">
          <article className="flex flex-col justify-between items-center space-y-8"> 
            ...
            <form className="flex flex-col w-full gap-6">
              ...
              <button
                type="submit"
                className="hover:bg-violet-600 bg-violet-400 text-white rounded-full h-12 w-full mt-6"
              >
                Suscribirse
              </button>
            </form>
